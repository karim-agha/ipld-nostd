...
///    - newtype variant -> single element `Ipld::Map`, key: variant name,
///      value: the one the newtype wraps
///    - tuple variant -> single element `Ipld::Map`, key: variant name, value:
///      `Ipld::List`
///    - struct variant -> single element `Ipld::Map`, key: variant name, value:
///      `Ipld::Map`
...
/// ```
/// use {
/// 	ipld_core::{ipld::Ipld, serde::to_ipld},
